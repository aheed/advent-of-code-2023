...
#def get_increment(iterator: ZNodeIterator) -> int:
#    current_z_node = iterator.z_nodes[iterator.current_index]    
#    iterator.current_index = current_z_node.next_index
#    return current_z_node.increment
...
def create_iterator(base_iterator: ZNodeIterator, loop: Loop) -> ZNodeIterator:
    ...
    while True:
        ...
        total_cnt = total_cnt + current_base_z_node.increment #wrong!!!!!!!!!!!!!!!!!!
...
#print(loops[0])
#print("---")
#simple_iterator = iterator_from_loop(loop=loops[0])
#print(simple_iterator)
#print("------")
#print(loops[1])
#print("----")
#i1 = create_iterator(base_iterator=simple_iterator, loop=loops[1])
#print(i1)
#################
